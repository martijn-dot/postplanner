...
insert into public.labels (project_id, column_type, value, color, is_default, scope) values
  ...
  (null, 'what', 'Offline V1', '#e8d69a', true, 'global'),
  (null, 'what', 'Offline V2', '#ddc87a', true, 'global'),
  (null, 'what', 'Offline Lock', '#bba0e7', true, 'global'),
  (null, 'what', 'Prefinal V1', '#a8ceff', true, 'global'),
  (null, 'what', 'Prefinal V2', '#91bcf8', true, 'global'),
  (null, 'what', 'Final', '#f2a3bd', true, 'global'),
  (null, 'what', 'Final Delivery', '#ffbd7a', true, 'global'),
  (null, 'what', 'Grading', '#91dfc4', true, 'global'),
  (null, 'what', 'Audio', '#a6e36d', true, 'global'),
  (null, 'todo', 'Offline V1', '#ffd166', true, 'global'),
  (null, 'todo', 'Offline V2', '#ffd166', true, 'global'),
  (null, 'todo', 'Offline V3', '#ffd166', true, 'global'),
  (null, 'todo', 'Offline Final', '#ffd166', true, 'global'),
  (null, 'todo', 'Offline Lock', '#b793ff', true, 'global'),
  (null, 'todo', 'PreFinal', '#54c7ff', true, 'global'),
  (null, 'todo', 'PreFinal V1', '#54c7ff', true, 'global'),
  (null, 'todo', 'PreFinal V2', '#54c7ff', true, 'global'),
  (null, 'todo', 'Final', '#ff5e84', true, 'global'),
  (null, 'todo', 'Final Delivery', '#46d39b', true, 'global'),
  (null, 'todo', 'Grading', '#8b8f9a', true, 'global'),
  (null, 'todo', 'Audio', '#8b8f9a', true, 'global'),
  (null, 'todo', '360 V1', '#9a6a43', true, 'global'),
  (null, 'todo', '360 V2', '#9a6a43', true, 'global'),
  (null, 'todo', 'CGI WIP V1', '#ff8f4f', true, 'global'),
  (null, 'todo', 'CGI WIP V2', '#ff8f4f', true, 'global'),
  (null, 'todo', 'CGI WIP V3', '#ff8f4f', true, 'global'),
  (null, 'todo', 'CGI Lock', '#b793ff', true, 'global'),
  (null, 'todo', 'DesignV1', '#f45fd2', true, 'global'),
  (null, 'todo', 'Design V2', '#f45fd2', true, 'global'),
  (null, 'todo', 'Design V3', '#f45fd2', true, 'global'),
  (null, 'todo', 'Photography V1', '#ffd166', true, 'global'),
  (null, 'todo', 'Photography V2', '#ffd166', true, 'global'),
  (null, 'todo', 'Creative V1', '#b793ff', true, 'global'),
  (null, 'todo', 'Creative V2', '#b793ff', true, 'global'),
  (null, 'todo', 'CAD/MUS/PGD', '#8b8f9a', true, 'global'),
  (null, 'todo', 'CIMA', '#8b8f9a', true, 'global'),
  (null, 'todo', 'Shoot', '#8b8f9a', true, 'global')
