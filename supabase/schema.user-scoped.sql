...
insert into public.labels (project_id, column_type, value, color, is_default, scope) values
  ...
  (null, 'todo', 'Share', '#9ad0a5', true, 'global'),
  (null, 'todo', 'Approval', '#d7b7ef', true, 'global'),
  (null, 'todo', 'Viewing at Wenneker', '#b7d3bd', true, 'global'),
  (null, 'todo', 'Session at Wenneker', '#ffc58d', true, 'global')
